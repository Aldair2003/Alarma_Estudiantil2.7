...
public class MemoryChallenge extends AppCompatActivity {
    ...
    int chopper, ichigo, sanji, luffyy, naruto, zoro,logo;
    int lastClicked = -1;
    int clicked = 0;
    int Score = 0;
    int Minute = 120 ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Integer> images = new ArrayList<>(Arrays.asList(chopper, ichigo, sanji, luffyy, naruto, zoro, chopper, ichigo, sanji, luffyy, naruto, zoro));
    ...
    private void SetUp() {
        ...
        logo = R.drawable.logo; chopper = R.drawable.naruto; ichigo =  R.drawable.chopper; sanji = R.drawable.zoro;
        luffyy = R.drawable.sanji; naruto = R.drawable.luffyy; zoro = R.drawable.ichigo;
    }
